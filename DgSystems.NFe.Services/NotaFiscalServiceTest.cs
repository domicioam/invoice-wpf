...
//                nfeConsulta, certificadoService, notaInutilizadaFacade, cancelaNotaFiscalService);

//            var notaFiscalService = new EnviarNotaFiscalService(configuracaoRepository, serviceFactory, nfeConsulta);

//            var modoOnlineService = new ModoOnlineService(configuracaoRepository, consultaStatusServicoService, notaFiscalRepository, notaFiscalContingenciaService, null);
...
//                notaFiscalContingenciaService, null);
...
//            var notaFiscalContingenciaService = new EmiteNotaFiscalContingenciaFacade(configuracaoRepository, notaFiscalRepository, emissorService, nfeConsulta, certificadoService, notaInutilizadaFacade, cancelaNotaFiscalService);
