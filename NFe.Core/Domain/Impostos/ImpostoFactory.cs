...
namespace NFe.Core.NotasFiscal.Impostos
{
                    ...
                    switch (imposto.CST)
                    {
                        ...
                        case "10":
                            return new Icms10((decimal)imposto.Aliquota, (decimal)imposto.BaseCalculo, CstEnum.CST10, origem, new FundoCombatePobreza(imposto.AliquotaFCP, imposto.BaseCalculoFCP), 
                                new SubstituicaoTributaria(new FundoCombatePobreza(imposto.AliquotaFCP, imposto.BaseCalculoFCP), imposto.BaseCalculoST, imposto.AliquotaST));
                    }
                    break;
