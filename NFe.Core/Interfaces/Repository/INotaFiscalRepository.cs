...
namespace NFe.Core.Interfaces
{
    public interface INotaFiscalRepository
    {
        ...
        int Salvar(NotaFiscal.NotaFiscal notaFiscal, string xml);
        ...
        int SalvarNotaFiscalPendente(NotaFiscal.NotaFiscal notaFiscal, string v);
        ...
        NotaFiscal.NotaFiscal GetNotaFiscalFromNfeProcXml(string xml);
        List<NotaFiscal.NotaFiscal> GetNotasFiscaisPorPeriodo(DateTime periodoInicial, DateTime dateTime, bool v);
        ...
        void SalvarXmlNFeComErro(NotaFiscal.NotaFiscal notaFiscal, XmlNode node);
    }
}