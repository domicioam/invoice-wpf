...
namespace NFe.Core.NotasFiscais.Repositories
{
    public static class ImpostoExtensions
    {
        public static Domain.Imposto ToImposto(this TNFeInfNFeDetImpostoICMSICMS60 detImposto)
        {
            ...
            var icms = new NFe.Core.Domain.Imposto
            {
        ...
        public static Domain.Imposto ToImposto(this TNFeInfNFeDetImpostoICMSICMS40 detImposto)
        {
        ...
        public static Domain.Imposto ToImposto(this TNFeInfNFeDetImpostoICMSICMS10 detImposto)
        {
