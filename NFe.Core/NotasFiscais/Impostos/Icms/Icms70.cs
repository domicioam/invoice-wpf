...
namespace NFe.Core
{
    ...
    /// </summary>
    internal class Icms70 : Icms, IcmsDesonerado, HasFundoCombatePobreza, HasSubstituicaoTributaria
    {
        public Icms70(Desoneracao desoneracaoIcms, Icms.CstEnum cst, OrigemMercadoria origem, FundoCombatePobreza fundoCombatePobreza, decimal aliquota) : base(cst, origem, aliquota)
        {
