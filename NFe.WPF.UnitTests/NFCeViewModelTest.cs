...
namespace NFe.WPF.UnitTests
{
    public class NFCeViewModelTest : IClassFixture<NotaFiscalFixture>
    {
        ...
        public void Deveria_gerar_pagamento()
        {
            ...
            var destinatario = new DestinatarioViewModel(new Mock<IEstadoRepository>().Object, new Mock<IEmissorService>().Object, destinatarioServiceMock.Object, new Mock<IMunicipioService>().Object);
