...
namespace NFe.WPF.UnitTests
{
    public class NFCeViewModelTest : IClassFixture<NotaFiscalFixture>
    {
        ...
        public void Deveria_enviar_nota_fiscal()
        {
            ...
            enviarNotaMock.Verify(m => m.EnviarNotaAsync(It.IsNotNull<NotaFiscalModel>(), It.IsAny<Modelo>(), It.IsAny<Core.NotasFiscais.Emissor>(), It.IsAny<X509Certificate2>(), It.IsAny<IDialogService>()), Times.Once);
        }
        ...
        public void Deveria_imprimir_nota_fiscal_quando_resposta_de_imprimir_é_sim()
        {
            ...
            nfce.EnviarNotaCmd.Execute(new Mock<IClosable>().Object);
            enviarNotaMock.Verify(m => m.EnviarNotaAsync(It.IsAny<NotaFiscalModel>(), It.IsAny<Core.NotasFiscais.Modelo>(), It.IsAny<Core.NotasFiscais.Emissor>(), It.IsAny<X509Certificate2>(), It.IsAny<IDialogService>()), Times.Once);
        ...
        public void Deveria_exibir_erro_quando_argument_exception_por_nota_fiscal_inválida()
        {
            ...
            var destinatario = new DestinatarioViewModel(new Mock<IEstadoRepository>().Object, new Mock<IEmissorService>().Object, destinatarioServiceMock.Object, new Mock<IMunicipioRepository>().Object);
            var enviarNotaMock = new Mock<IEnviarNotaAppService>();
            enviarNotaMock.Setup(m => m.EnviarNotaAsync(It.IsAny<NotaFiscalModel>(), It.IsAny<Modelo>(), It.IsAny<Core.NotasFiscais.Emissor>(), It.IsAny<X509Certificate2>(), It.IsAny<IDialogService>()))
