...
namespace DgSystem.NFe.Reports.Nfe
{
    ...
    {
        public NotaFiscal(string qrCodeUrl, Identificacao identificacao, Emitente emitente, 
            Destinatario destinatario, IEnumerable<Produto> produtos, IEnumerable<Pagamento> pagamentos, 
            double valorTotalProdutos, string protocoloAutorizacao, DateTime dhAutorizacao, 
            string infoAdicionalComplementar, int qtdTotalProdutos, Veiculo veiculo,
            Transportadora transportadora, CalculoImposto calculoImposto)
        {
            QrCodeUrl = qrCodeUrl;
        ...
        public CalculoImposto IcmsTotal { get; internal set; }
    }
}
